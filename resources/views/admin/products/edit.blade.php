                              ...
                              <div class="row">
                                  <div class="col-md-4">
                                      <div class="form-group">
                                          ...
                                          <input class="form-control" type="file" name="tumbnail_url">
                                      </div>
                                      <img src="/{{ $product->tumbnail_url }}" alt="" width="100px" height="100px">
                                  </div>
                                  <div class="col-md-4">
                                      <div class="form-group">
                                  ...
                                  <div class="col-md-4">
                                      ...
                                      <a href="{{ route('admin.products.download.source',$product->id) }}" class="btn btn-default btn-icons" title="لینک دانلود">Download here</a>
